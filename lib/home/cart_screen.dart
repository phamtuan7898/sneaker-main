...
class _CartScreenState extends State<CartScreen> {
  ...
  static const double exchangeRate = 24000.0; // Example: 1 USD = 24,000 VND
  ...
  double getTotalPriceInVND() {
    return cartItems.fold(
      0,
      (total, item) =>
          total + (item.getTotalPrice() * item.quantity * exchangeRate),
    );
  }
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomAppBar(
        child: Padding(
          padding: const EdgeInsets.all(16.0),
          child: Text(
            'Tổng: ₫${getTotalPriceInVND().toStringAsFixed(0)}', // Ensure this returns a double
